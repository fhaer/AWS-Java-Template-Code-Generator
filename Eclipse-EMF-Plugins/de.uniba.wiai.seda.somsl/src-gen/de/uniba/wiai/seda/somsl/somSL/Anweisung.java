 ...
 * <ul>
 *   <li>{@link de.uniba.wiai.seda.somsl.somSL.Anweisung#getKontrollstruktur <em>Kontrollstruktur</em>}</li>
 *   <li>{@link de.uniba.wiai.seda.somsl.somSL.Anweisung#getBedingung <em>Bedingung</em>}</li>
 *   <li>{@link de.uniba.wiai.seda.somsl.somSL.Anweisung#getBedigteAnweisungen <em>Bedigte Anweisungen</em>}</li>
 *   <li>{@link de.uniba.wiai.seda.somsl.somSL.Anweisung#getObjekt <em>Objekt</em>}</li>
 *   <li>{@link de.uniba.wiai.seda.somsl.somSL.Anweisung#getOperator <em>Operator</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.uniba.wiai.seda.somsl.somSL.SomSLPackage#getAnweisung()
 * @model
 * @generated
 */
public interface Anweisung extends EObject
{
   ...
   * @see de.uniba.wiai.seda.somsl.somSL.SomSLPackage#getAnweisung_Kontrollstruktur()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.uniba.wiai.seda.somsl.somSL.Anweisung#getKontrollstruktur <em>Kontrollstruktur</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.uniba.wiai.seda.somsl.somSL.SomSLPackage#getAnweisung_Bedingung()
  ...
  /**
   * Sets the value of the '{@link de.uniba.wiai.seda.somsl.somSL.Anweisung#getBedingung <em>Bedingung</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link de.uniba.wiai.seda.somsl.somSL.Anweisung}.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @see de.uniba.wiai.seda.somsl.somSL.SomSLPackage#getAnweisung_BedigteAnweisungen()
   * @model containment="true"
   * @generated
   */
   ...
   * @see de.uniba.wiai.seda.somsl.somSL.SomSLPackage#getAnweisung_Objekt()
   * @model
   * @generated
   */
  Objekttyp getObjekt();
  ...
  /**
   * Sets the value of the '{@link de.uniba.wiai.seda.somsl.somSL.Anweisung#getObjekt <em>Objekt</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.uniba.wiai.seda.somsl.somSL.SomSLPackage#getAnweisung_Operator()
   * @model
   * @generated
   */
  String getOperator();
  ...
  /**
   * Sets the value of the '{@link de.uniba.wiai.seda.somsl.somSL.Anweisung#getOperator <em>Operator</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
