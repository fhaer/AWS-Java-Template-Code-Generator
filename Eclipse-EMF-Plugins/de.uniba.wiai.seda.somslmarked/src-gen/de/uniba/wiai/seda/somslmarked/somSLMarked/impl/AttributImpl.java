 ...
 * <ul>
 *   <li>{@link de.uniba.wiai.seda.somslmarked.somSLMarked.impl.AttributImpl#getObjekttyp <em>Objekttyp</em>}</li>
 *   <li>{@link de.uniba.wiai.seda.somslmarked.somSLMarked.impl.AttributImpl#getDatentyp <em>Datentyp</em>}</li>
 *   <li>{@link de.uniba.wiai.seda.somslmarked.somSLMarked.impl.AttributImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AttributImpl extends MinimalEObjectImpl.Container implements Attribut
{
  ...
  {
    return SomSLMarkedPackage.Literals.ATTRIBUT;
  }
    ...
    if (objekttyp != null && objekttyp.eIsProxy())
    {
      ...
      if (objekttyp != oldObjekttyp)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SomSLMarkedPackage.ATTRIBUT__OBJEKTTYP, oldObjekttyp, objekttyp));
      }
    }
    return objekttyp;
  }
  ...
  public void setObjekttyp(Objekttyp newObjekttyp)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SomSLMarkedPackage.ATTRIBUT__OBJEKTTYP, oldObjekttyp, objekttyp));
  }
  ...
  public void setDatentyp(String newDatentyp)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SomSLMarkedPackage.ATTRIBUT__DATENTYP, oldDatentyp, datentyp));
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SomSLMarkedPackage.ATTRIBUT__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SomSLMarkedPackage.ATTRIBUT__OBJEKTTYP:
        if (resolve) return getObjekttyp();
        return basicGetObjekttyp();
      case SomSLMarkedPackage.ATTRIBUT__DATENTYP:
        return getDatentyp();
      case SomSLMarkedPackage.ATTRIBUT__NAME:
        return getName();
    }
