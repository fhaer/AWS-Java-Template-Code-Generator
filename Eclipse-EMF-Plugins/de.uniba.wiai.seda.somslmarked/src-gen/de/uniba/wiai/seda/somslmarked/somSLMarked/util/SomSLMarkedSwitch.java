 ...
 * @generated
 */
public class SomSLMarkedSwitch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case SomSLMarkedPackage.SCHEMA:
      {
      ...
      case SomSLMarkedPackage.OBJEKTTYP:
      {
      ...
      case SomSLMarkedPackage.BEZIEHUNG:
      {
      ...
      case SomSLMarkedPackage.KARDINALITAET:
      {
