 ...
 * <ul>
 *   <li>{@link de.uniba.wiai.seda.somslmarked.somSLMarked.impl.OperatorImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.uniba.wiai.seda.somslmarked.somSLMarked.impl.OperatorImpl#getParameter <em>Parameter</em>}</li>
 *   <li>{@link de.uniba.wiai.seda.somslmarked.somSLMarked.impl.OperatorImpl#getAnweisungen <em>Anweisungen</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OperatorImpl extends MinimalEObjectImpl.Container implements Operator
{
  ...
  {
    return SomSLMarkedPackage.Literals.OPERATOR;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SomSLMarkedPackage.OPERATOR__NAME, oldName, name));
  }
  ...
  public EList<Objekttyp> getParameter()
  {
    if (parameter == null)
    {
      parameter = new EObjectResolvingEList<Objekttyp>(Objekttyp.class, this, SomSLMarkedPackage.OPERATOR__PARAMETER);
    }
    return parameter;
  }
  ...
  public EList<Anweisung> getAnweisungen()
  {
    if (anweisungen == null)
    {
      anweisungen = new EObjectContainmentEList<Anweisung>(Anweisung.class, this, SomSLMarkedPackage.OPERATOR__ANWEISUNGEN);
    }
    return anweisungen;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SomSLMarkedPackage.OPERATOR__ANWEISUNGEN:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SomSLMarkedPackage.OPERATOR__NAME:
        return getName();
      case SomSLMarkedPackage.OPERATOR__PARAMETER:
        return getParameter();
      case SomSLMarkedPackage.OPERATOR__ANWEISUNGEN:
