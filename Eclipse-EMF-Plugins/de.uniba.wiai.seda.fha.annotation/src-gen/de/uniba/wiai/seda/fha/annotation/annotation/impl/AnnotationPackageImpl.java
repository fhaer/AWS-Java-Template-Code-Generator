...
import de.uniba.wiai.seda.fha.annotation.annotation.AnnotationFactory;
...
public class AnnotationPackageImpl extends EPackageImpl implements AnnotationPackage
{
   ...
   * @see de.uniba.wiai.seda.fha.annotation.annotation.AnnotationPackage#eNS_URI
   * @see #init()
   * @generated
   */
  ...
  public void initializePackageContents()
  {
    ...
    versionEClass.getESuperTypes().add(this.getAnnotation());
